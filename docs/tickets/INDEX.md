...
| 5a | **[quick-share-single-item](to-do/quick-share-single-item.md)** | ~0.5 day | Real user feedback (Katie, 2026-08-22): wanted a QR for one paper inside a multi-item share, had none, used Chrome's QR instead. Small, reuses existing `create_share`/`QrModal`. Pairs with 0a's QR work. | none |
