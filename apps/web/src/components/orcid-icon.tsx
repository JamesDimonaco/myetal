/**
 * ORCID iD logo. Multi-colour SVG — uses ORCID's brand green (#A6CE39)
 * with white "iD" letters. Per ORCID brand guidelines, the mark should
 * keep its colours regardless of background, so we don't use currentColor.
 */
