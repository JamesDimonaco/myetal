...
/**
 * Wraps the app in a TanStack Query client. Server components don't need this
 * — they fetch directly via `serverFetch` and pass data down — but client
 * components (forms, dashboards with optimistic updates) get caching and
 * mutation state from useQuery / useMutation.
 *
