...
const nextConfig: NextConfig = {
  // Transpile the workspace contract package (ships TypeScript source, not a
  // build artifact). Next compiles it alongside the app.
  transpilePackages: ['@myetal/api-contract'],
