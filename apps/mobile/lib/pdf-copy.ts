/**
 * Shared copy strings for the PDF upload flow (mobile).
 *
 * Single source of truth so web + mobile stay aligned. Mirrors
 * apps/web/src/lib/pdf-copy.ts (see PR-C feedback M4). When you change a
